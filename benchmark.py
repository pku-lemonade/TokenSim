...
from TokenSim.config.accelerator_memory import configure_run_hardware
...
def main(args: argparse.Namespace):
    ...
    effective_hardware_profile = configure_run_hardware(
        roofline,
        cluster,
        kv_transfer_config,
    )
    ...
    engine.effective_hardware_profile = (
        effective_hardware_profile.to_dict()
        if effective_hardware_profile is not None
        else None
    )
